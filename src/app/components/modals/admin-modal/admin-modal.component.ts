...
export class AdminModalComponent implements OnInit {
  ...
  openModal(content: TemplateRef<any>): void {
    ...
    this.selectedTeacher = this.dayClass.classn.teacher;
  ...
  onSave(){
    ...
    this.dayClass.classn.teacher = this.selectedTeacher;
    this.dayClass.classn.year= Number(this.class_year);
    this.dayClass.classn.section = this.class_section;
    var hour: string;
    var minute: string;
  ...
  filterTeachers(): User[]{
    return this.teachers.filter(teacher => teacher.id != this.dayClass.classn.teacher.id);
  }
